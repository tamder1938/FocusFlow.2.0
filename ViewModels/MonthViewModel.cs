...
public partial class MonthViewModel : ObservableObject
{
    ...
    // Коллекция для заголовков дней недели (Mon, Tue...)
    ...
    public MonthViewModel(IDatabaseService db)
    {
        ...
        // При смене языка мгновенно перерисовываем заголовки и ячейки
    ...
    private void UpdateLocalization()
    {
        ...
        // Форматируем заголовок (например, "май 2026" или "May 2026")
        MonthYearTitle = CurrentMonthDate.ToString("MMMM yyyy", culture);

        // Перезаполняем заголовки дней недели
    ...
    public void RefreshMonth()
    {
        ...
        DateTime firstDayOfMonth = CurrentMonthDate;
        int offsetDays = (7 + (firstDayOfMonth.DayOfWeek - DayOfWeek.Monday)) % 7;
        DateTime startDate = firstDayOfMonth.AddDays(-offsetDays);
        ...
        for (int i = 0; i < 42; i++)
        {
            ...
            {
                Date = currentDay,
                IsCurrentMonth = currentDay.Month == CurrentMonthDate.Month,
